...
const TeamsManagement = () => {
  ...
  // Badge Color Logic
  const statusStyles = {
    Active: "text-green-600 bg-green-400/15 border-green-500/50",
    Busy: "text-yellow-500 bg-yellow-400/15 border-yellow-500/50",
    "On Leave": "text-red-600 bg-red-400/15 border-red-500/50",
  };
    ...
    <div className="p-6 md:p-8 text-gray-800">
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-gray-800 mt-1">Create and manage your teams</p>
        </div>
        ...
        <button
          ...
          "
        >
          <UserPlus size={20} className="text-indigo-800" />
          Create Team
        </button>
      </div>
      ...
      <div className="mb-8">
        <div
          className="
            ...
            bg-white/30 border border-purple-300/30 
        ...
        {filteredTeams.map((team, index) => (
          <div
            ...
            className="
              ...
              border border-purple-300/30 backdrop-blur-xl 
          ...
          >
            ...
            <div className="absolute top-4 right-4 flex gap-3">
              <button
                className="
                  p-2 rounded-lg bg-black border border-purple-300/30
                  hover:bg-rose-300/30 transition-all
                "
              >
            ...
            <div className="flex items-center gap-3 mb-4">
              <Users size={28} className="text-purple-800" />
              <h2 className="text-xl font-semibold">{team.name}</h2>
            </div>

            {/* TEAM MEMBERS */}
            <p className="text-gray-800 text-sm mb-3">Team Members</p>
            ...
            <div className="space-y-4">
              ...
              {team.members.map((member, i) => (
                <div
                  ...
                  className="
                    p-3 rounded-xl 
                    bg-white/30 border border-purple-800/20 
